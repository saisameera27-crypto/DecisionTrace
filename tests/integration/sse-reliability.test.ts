...
describe('SSE Reliability Tests', () => {
  ...
  describe('Basic SSE Connection', () => {
    ...
    it('should receive messages from SSE stream', async () => {
      return new Promise<void>((resolve, reject) => {
        ...
        // Set timeout to prevent hanging
        const timeout = setTimeout(() => {
          reject(new Error('SSE message reception timeout'));
        }, 10000);
  ...
  describe('Refresh Mid-Run', () => {
    it('should reconnect and continue after refresh during step 2-4', async () => {
      return new Promise<void>((resolve, reject) => {
        ...
        // Set timeout to prevent hanging
        const timeout = setTimeout(() => {
          reject(new Error('SSE refresh test timeout'));
        }, 15000);
    ...
    it('should handle refresh during step processing', async () => {
      return new Promise<void>((resolve, reject) => {
        let refreshHappened = false;
        
        // Set timeout to prevent hanging
        const timeout = setTimeout(() => {
          reject(new Error('SSE refresh during processing test timeout'));
        }, 15000);
  ...
  describe('Network Drop and Reconnect', () => {
    it('should handle network drop and reconnect', async () => {
      return new Promise<void>((resolve, reject) => {
        eventSource = new MockEventSource('/api/case/test-case-123/events');
        ...
        // Set timeout to prevent hanging
        const timeout = setTimeout(() => {
          reject(new Error('SSE network drop test timeout'));
        }, 15000);
    ...
    it('should handle multiple network drops', async () => {
      return new Promise<void>((resolve, reject) => {
        eventSource = new MockEventSource('/api/case/test-case-123/events');
        let dropCount = 0;
        let finalStep = 0;
        ...
        // Set timeout to prevent hanging
        const timeout = setTimeout(() => {
          reject(new Error('SSE multiple drops test timeout'));
        }, 20000);
  ...
  describe('Tab Backgrounding', () => {
    it('should continue receiving messages when tab is backgrounded', async () => {
      return new Promise<void>((resolve, reject) => {
        eventSource = new MockEventSource('/api/case/test-case-123/events');
        ...
        // Set timeout to prevent hanging
        const timeout = setTimeout(() => {
          reject(new Error('SSE tab background test timeout'));
        }, 15000);
    ...
    it('should resume correctly when tab is foregrounded', async () => {
      return new Promise<void>((resolve, reject) => {
        eventSource = new MockEventSource('/api/case/test-case-123/events');
        ...
        // Set timeout to prevent hanging
        const timeout = setTimeout(() => {
          reject(new Error('SSE tab foreground test timeout'));
        }, 15000);
  ...
  describe('SSE Cleanup', () => {
    it('should close SSE connection cleanly at completion', async () => {
      return new Promise<void>((resolve, reject) => {
        eventSource = new MockEventSource('/api/case/test-case-123/events');
        
        // Set timeout to prevent hanging
        const timeout = setTimeout(() => {
          reject(new Error('SSE cleanup test timeout'));
        }, 15000);
    ...
    it('should not leave infinite spinner after completion', async () => {
      return new Promise<void>((resolve, reject) => {
        eventSource = new MockEventSource('/api/case/test-case-123/events');
        let completed = false;
        ...
        // Set timeout to prevent hanging
        const timeout = setTimeout(() => {
          reject(new Error('SSE spinner test timeout'));
        }, 15000);
